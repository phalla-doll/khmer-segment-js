...
- [x] Meets all performance guardrails in "Cross-Phase Execution Rules" _(latency within 1.8x BiMM, deterministic)_
- [x] All new segmentation tests and perf tests pass in CI _(173 tests pass)_
...
- [x] Document baseline accuracy numbers in the README
- [x] Create `docs/benchmark-results.md` with per-strategy comparison table
...
- [x] Benchmark script is deterministic and reproducible on a clean checkout
- [x] Methodology doc is complete enough for third-party reproduction
- [x] Baseline report includes all primary/secondary metrics and runtime stats
...
- [x] Review Sovichea's curated dictionary for gaps
- [x] Update `scripts/build-dictionary.ts` to add new sources with appropriate weights
- [x] Rebuild dictionary and verify new word count _(101,107 words)_
- [x] Run accuracy benchmark (Phase 2) to measure improvement — BiMM F1 = 0.8041 on 87,875-sentence benchmark
- [x] Verify no duplicates or invalid entries
...
- [x] Dictionary size reaches **55,000+** valid entries _(achieved: 101,107)_
- [x] No duplicate entries after normalization pipeline
...
- [x] Added/changed data sources are license-reviewed and documented
